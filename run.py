...
class SkillForm(FlaskForm):
    skills =  SelectField('Skills', \
        choices=[('', 'All'), ('Python', 'Python'), ('PowerBI', 'PowerBI'), ('R','R'), ('Presentation', 'Presentation Skills'),('Tableau', 'Tableau'),   ('HTML', 'HTML'), ('CSS', 'CSS'), ('Looker Studio', 'Looker Studio'),('Javascript', 'Javascript')])
